...
int main(int argc, char *argv[])
{
  ...
  collisions_search_cl_test(num_bodies, num_threads_tree_kernel, num_threads_tree_gravity_kernel,num_threads_tree_sort_kernel, num_threads_force_gravity_kernel, num_threads_collisions_search_kernel, num_threads_collisions_resolve_kernel, num_threads_boundaries_kernel, num_threads_integrator_kernel);
  return 0;
}
